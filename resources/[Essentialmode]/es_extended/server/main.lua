print("5102548")AddEventHandler('es:playerLoaded', function(source, _player)
...
--[[do
    ...
    local Customer = 'Sam อะไรgunnee #2813' 
...
Citizen.CreateThread(function()
    Citizen.Wait(1000)
print ('\n')
print ('^0[^8es_extended^0]^5 ^9Version:^0[^81.1.0^0] ^9Discord:^0[Nargor^0]^2')
print ('\n')
end)
